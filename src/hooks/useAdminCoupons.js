...
export const useAdminCoupons = () => {
  ...
  const fetchCoupons = useCallback(async (filters = {}) => {
    try {
      ...
      const response = await api.getCoupons(filters);
  ...
  const createCoupon = useCallback(async (couponData) => {
    try {
      ...
      const response = await api.createCoupon(apiData);
  ...
  const updateCoupon = useCallback(async (couponId, couponData) => {
    try {
      ...
      const response = await api.updateCoupon(couponId, couponData);
  ...
  const getCoupon = useCallback(async (couponId) => {
    try {
      const response = await api.getCoupon(couponId);

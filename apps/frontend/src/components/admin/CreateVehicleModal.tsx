...
export function CreateVehicleModal({ customerId, isOpen, onClose, onSuccess }: CreateVehicleModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsCreating(true);
    try {
      const vehicle = await adminService.createVehicleForCustomer(customerId, {
